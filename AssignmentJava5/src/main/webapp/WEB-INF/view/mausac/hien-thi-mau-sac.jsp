...
<center><h1>Quản Lý Màu Sắc</h1></center>
        ...
        <table class="table" border="1px">
            ...
            <c:forEach items="${listMS.content}" var="ms">
                <tr>
                    ...
                    <td>${ms.ten}</td>
                    <td>
                        <a class="btn btn-warning" href="/mau-sac/detail/${ms.id}">Update</a>
                        <a class="btn btn-danger" href="/mau-sac/remove/${ms.id}">Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>

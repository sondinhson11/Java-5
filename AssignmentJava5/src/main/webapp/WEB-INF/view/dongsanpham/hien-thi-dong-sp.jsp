...
<center><h1>Quản Lý Dòng Sản Phẩm</h1></center>
<div class="row">
    <div class="col-2"></div>
    <div class="col-8">
        ...
        <table class="table" border="1px">
            ...
            <c:forEach items="${listDSP.content}" var="dsp">
                <tr>
                    ...
                    <td>${dsp.ten}</td>
                    <td>
                        <a class="btn btn-warning" href="/dongSP/detail/${dsp.id}">Update</a>
                        <a class="btn btn-danger" href="/dongSP/delete/${dsp.id}">Delete</a>

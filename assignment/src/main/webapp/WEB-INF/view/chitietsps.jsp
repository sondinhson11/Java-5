...
<div class="row">
    ...
    <div class="col-8">
        <form:form action="/chi-tietSP/add" method="post" modelAttribute="chiTietSP">
            ...
            Năm BH:<form:input class="form-control" path="namBH" type="number"/> <br>
            Mô Tả:<form:input class="form-control" path="moTa"/> <br>
            Số Lượng Tồn:<form:input class="form-control" path="soLuongTon" type="number"/> <br>
            Giá Nhập:<form:input class="form-control" path="giaNhap" type="text"/> <br>
            Giá Bán:<form:input class="form-control" path="giaBan" type="text"/> <br>
            <form:button class="btn btn-primary" type="dubmit">Thêm</form:button>
        ...
        <table class="table" border="1px">
            ...
            <c:forEach items="${listCTSP.content}" var="ctsp">
                <tr>
                    ...
                    <td>${ctsp.giaBan}</td>
                    <td>
                        <a href="/chi-tietSP/remove/${ctsp.id}" class="btn btn-primary" >Delete</a>
                        <a href="/chi-tietSP/detail/${ctsp.id}" class="btn btn-primary" >Update</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
